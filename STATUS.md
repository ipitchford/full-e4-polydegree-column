...
- Date: 23 August 2026
- Status: anonymous unrefereed candidate
- Principal claim: for every integer $d\ge2$,
  $\mathcal G_{(d+4)}\subseteq\overline{\mathcal G_{(d,5)}}$.
- Proof type: theoretical and computer-assisted
- Finite computation: 14,985 outward-rounded FLINT/Arb certificates
- Eventual branch: explicit analytic estimate for $m\ge5000$
- Formal companion: Lean 4.32.1 / Mathlib v4.32.1, arbitrary commutative rings
